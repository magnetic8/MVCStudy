				...
				<div class="col></div>
					<div class="col-md-10">
                      ...
                      <div>
                        ...
                        <input readonly type="text" class="form-control" id="user_name" name="user_name"
						maxlength="50" placeholder="이름을 입력해주세요">
                       </div>                  
										</div>
									...
									<div class="form-group mb-3 ">
										...
										<div>
											...
											<input type="password" class="form-control" id="u_pw"
												name="u_pw" maxlength="50" placeholder="기존 비밀번호를 입력해주세요." required>
												
										</div>
										</div>
										<div class="form-group mb-3 ">
											<label class="form-label required">비밀번호 수정</label> 
                      <div>
                      
                        <input type="password" class="form-control" id="u_pwcheck" name="u_pwcheck"
						maxlength="50" required placeholder="수정할 비밀번호를 입력해주세요">  
										...
										<div class="form-group mb-3 ">
											...
											<div class="input-group mb-2 mt-2">
				                              <input type="text" class="form-control" id="u_nick" maxlength="20" placeholder="수정할 닉네임을 입력해주세요" name="u_nick" autocomplete="off" onchange="fn_niccheck()">
