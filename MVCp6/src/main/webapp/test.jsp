		...
		<!-- WEB-INF폴더에서 사용시 page="../header/header.jsp"로 변경 -->
			...
			<input type="hidden" name="chk" value=0>
                    <div class="form-group mb-3 ">
                      ...
                      <small class="form-hint">이메일 형식으로 입력해주세요.</small>
                      <div >
                        <input type="email" class="form-control" aria-describedby="emailHelp" placeholder="Enter email" id="login_id" name="login_id" 
                        maxlength="50" required onchange="fn_idcheck()" >
                        <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                        <a href="#" class="btn btn-info w-100" button type="button" onclick="fn_idcheck()">
                        중복확인
                        </button></td>
                        </a>
                        </div>
                    ...
                    <div class="form-group mb-3 ">
                      ...
                      <small class="form-hint">비밀번호를 8자리 이상 입력해주세요.</small>
                      <div >
                        <input type="password" class="form-control" id="u_pw" name="u_pw" maxlength="50" placeholder="Password" required>
                        
                      </div>
                       <div class="form-group mb-3 ">
                      <label class="form-label required">비밀번호 확인</label>
                      <small class="form-hint">
                          비밀번호에서 사용한 비밀번호를 입력해주세요.
                        </small
                      <div >
                        <input type="password" class="form-control" id="u_pwcheck" name="u_pwcheck"
						maxlength="50" required placeholder="Password2">               
                      </div>
                      <div class="form-group mb-3 ">
                      <label class="form-label required">이름</label>
                      <small class="form-hint">이름을 입력해주세요.</small>
                      <div >
                        <input type="text" class="form-control" id="user_name" name="user_name"
						maxlength="50" placeholder="이름 입력">
                        
                      </div>
                    </div>
                    <div class="form-group mb-3 ">
                      <label class="form-label required">닉네임</label>
                      <small class="form-hint">닉네임을 입력해주세요.</small>
                      <div>
                        <input type="text" class="form-control" id="u_nick" name="u_nick"
						maxlength="20" placeholder="닉네임 입력" required
						onchange="fn_niccheck()">
                        <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                        <a href="#" class="btn btn-info w-100" button type="button" onclick="fn_niccheck()">중복확인</button></a></td>                   
                      </div>
                      </div>
                    </div>
                    </div>
                    <div class="form-group mb-3 ">
                      ...
                      <small class="form-hint">생일을 선택해주세요.</small>
                      <div >
                        <input type="date" id="u_birthdate" name="u_birthdate" class="form-control" required >
                        
                      </div>
                    </div>
                    <div class="form-group mb-3 ">
                      <label class="form-label required">주소</label>
                      <small class="form-hint">주소를 입력해주세요</small>
                      </div>
                    <div class="form-group mb-3 ">
					<input type="text" id="sample6_postcode" class="form-control" name="post"
						placeholder="우편번호">
					 <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
					 
					<input type="button" onclick="sample6_execDaumPostcode()" a href="#" class="btn btn-info w-120"
						value="우편번호 찾기">
						</a>
					<br>
            ...
            oncomplete: function(data) {
                ...
                document.getElementById("sample6_detailAddress").focus();
                    ...
                    <div class="form-footer">
                      <button type="submit" class="btn btn-primary" onclick="fn_submit();return false;">가입</button>
                    </div>
                  </form>
                </div>
              </div>
