...
<body>
			...
			<table>
				...
				<tr>
					...
					<td><input type="password" id="pw" name="pw" maxlength="50"
						placeholder="8자리 이상" required onchange="checkPw()"></td>
				</tr>

				<tr>
					<td for="pwcheck">비밀번호 확인</td>
					<td><input type="password" id="pwcheck" name="pwcheck"
						maxlength="50" required onchange="comparePw()"></td>
				</tr>
	...
	<div class="modal fade" id="checkModal" tabindex="-1" role="dialog" sria-hidden="true">
	...
	<script>
		...
		/*function fn_idcheck(){
			...
			var url="idCheckdo?user_id="+document.frm.user_id.value;
			window.open(url,"중복아이디체크","width=300,height=200");
		}
		
		function idok(){
			opener.frm.user_id.value=document.frm.user_id.value;
			opener.frm.chk.value=document.frm.user_id.value;
			self.close();
		}
		*/
		 //비번 8자리이상입력
