			...
			<div class="container-md">
				<div class="row row-card mt-3">
							...
							<div class="col-lg-4 mb-3">
								<div class="card ">
					    			<div class="text-muted"><image src="${vo.logo }" style="width:45px;"><span class="text-center ms-3">${vo.name }</span></div>
					    			<div style="height:210px">	<iframe width="100%" height="100%"   src="${vo.video }" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					    			</div>
