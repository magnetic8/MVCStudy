				...
				<div class="page page-login">
					<div class="container-tight pb-3">
						...
						<form class="card card-md" action="${cpath}/login.do" method="post"
							autocomplete="off">
							<div class="card-body">
								<h2 class="card-title text-center mb-4">Login to your
									account</h2>
								<div class="mb-3">
								...
								<div class="mb-2">
									...
									<div class="input-group input-group-flat">
										<input type="password" class="form-control"
											placeholder="Password" id="u_pw" name="u_pw" autocomplete="off"> <span
								...
								<div class="row">
									<div class="col">
										<a href="#" id="kakao-login-btn" class="btn login-kakao btn-white w-100 "> <!-- Download SVG icon from http://tabler-icons.io/i/brand-twitter -->
											...
											<i class="xi-kakaotalk login-kakao-icon" ></i>&nbsp;Login
											with Kakao
										</a>
									</div>
								</div>
					...
					<div class="text-center text-muted mt-3">
						Don't have account yet? <a href="${cpath}/joinForm.do" tabindex="-1">Sign
							up</a>
					</div>
				</div>
			</div>
