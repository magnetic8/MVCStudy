					...
					<div class="col-md-6">
							...
							<div class="card-body">
								<form method="post" action="${cpath}/join.do" name="frm"
									...
									<div class="form-group mb-3 ">
										<label class="form-label required">이메일</label> <small
											class="form-hint">이메일 형식으로 입력해주세요.</small>
										<div>
									...
									<div class="form-group mb-3 ">
										<label class="form-label required">비밀번호</label> <small
											class="form-hint">비밀번호를 8자리 이상 입력해주세요.</small>
										<div>
										<div class="input-group mb-2 mt-2">
											<input type="password" class="form-control" id="u_pw"
												name="u_pw" maxlength="50" placeholder="Password" required>
												</div>
										</div>
										</div>
										<div class="form-group mb-3 ">
											<label class="form-label required">비밀번호 확인</label> <small
												class="form-hint"> 비밀번호에서 사용한 비밀번호를 입력해주세요. </small>
                      <div>
                      <div class="input-group mb-2 mt-2">
                      ...
                      <div class="input-group mb-2 mt-2">
						...
						maxlength="50" placeholder="이름 입력">
										...
										<div class="form-group mb-3 ">
											<label class="form-label required">닉네임</label> <small
												class="form-hint">닉네임을 입력해주세요.</small>
											<div>
											<div class="input-group mb-2 mt-2">
												<input type="text" class="form-control" id="u_nick"
													name="u_nick" maxlength="20" placeholder="닉네임 입력" required
									...
									<div class="form-group mb-3 ">
										<label class="form-label required">생일</label> <small
											class="form-hint">생일을 입력해주세요</small>
											<div class="mb-2 mt-2">
											</div>
										<div>
									...
									<div class="form-group mb-3 ">
										<label class="form-label required">주소</label> <small
											class="form-hint">주소를 입력해주세요</small>
