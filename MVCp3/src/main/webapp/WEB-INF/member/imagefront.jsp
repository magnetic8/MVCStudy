...
<body>
	<div class="page">
      ...
      <div class="container">
        ...
        <hr>
         <div class="row">
        <div class="col-md-6 col-lg-3 fl33">
          <div class="card">
            <div class="card-img-top img-responsive img-responsive-21x9" style="background-image: url(https://www.idaegu.co.kr/news/photo/202102/2021020801000223700014051.jpg)"></div>
            <div class="card-body">
              <h3 class="card-title">함께하는 제로웨이스트</h3>
              <p class="text-muted">환경을 지키는 첫 번째 발걸음. 제로웨이스트 빠밤</p>
              <p class="text-muted fs10 mbau">닉네임 : 마늘</p>
              <p class="text-muted fs10 mbau">날짜 : 2022.08.31</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 fl33">
          <div class="card">
            <div class="card-img-top img-responsive img-responsive-21x9" style="background-image: url(https://file2.nocutnews.co.kr/newsroom/image/2018/05/16/20180516145506306682_0_1100_719.jpg)"></div>
            <div class="card-body">
              <h3 class="card-title">함께하는 제로웨이스트</h3>
              <p class="text-muted">환경을 지키는 첫 번째 발걸음. 제로웨이스트 빠밤</p>
              <p class="text-muted fs10 mbau" >닉네임 : 마늘</p>
